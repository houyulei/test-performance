...
/***/ function(module, exports, __webpack_require__) {
	...
	document.getElementById('repeat').addEventListener('change', function (e) {
	    (0, _dom.setRepeat)(content, e.currentTarget.value);
	}, false);

	document.getElementById('refresh').addEventListener('click', function (e) {
	    (0, _dom.refresh)(content);
	}, false);

	document.getElementById('append').addEventListener('click', function (e) {
	    (0, _dom.append)(content);
	}, false);
...
/***/ function(module, exports, __webpack_require__) {
	...
	function setRepeat(el, r) {
	    repeat = +r;
	    render(el);
	}

	function fetchData(el, type) {
	    (0, _util.ajax)({
